...
class NSLTransformer(nn.Module):
    def __init__(self, vocab_size, feature_dim=225, d_model=256, nhead=8, num_layers=4):
        super().__init__()
    ...
    def forward(self, src_tokens, tgt_motion):
        """
        src_tokens: [Batch, Text_Len] (The Nepali Characters)
        tgt_motion: [Batch, Motion_Len, 225] (The Animation frames)
        """
